...
def build() -> None:
    ...
    review_qa = node(10, "T8_FireRedAudio_SpeechQA", [3010, 100], [0.2, 0.001, 0.8, 0.5, 512], [port("model", "T8_FIREREDAUDIO_MODEL", 13), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 14)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA", [16]), out("qa_report", "STRING", slot_index=1), out("failed_line_ids", "STRING", slot_index=2)], [440, 350])
    ...
    review_qa_final = node(13, "T8_FireRedAudio_SpeechQA", [5240, 100], [0.2, 0.001, 0.8, 0.5, 512], [port("model", "T8_FIREREDAUDIO_MODEL", 21), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 20)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA", [23]), out("qa_report", "STRING", slot_index=1), out("failed_line_ids", "STRING", slot_index=2)], [440, 350])
    ...
    save("api_26_production_review_loop", {
        ...
        "13": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["12", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512}},
