...
def build() -> None:
    ...
    review_fit = node(9, "T8_FireRedAudio_DurationFit", [2470, 100], ["speech_aware", 0.1, 1.15, False, 0.9, "v017-review-fit", "fireredaudio/duration-fit", -40.0, 0.05, 0.12, 0.18, 1.12], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 12)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [14, 15]), out("manifest_path", "STRING", slot_index=1), out("retry_line_ids", "STRING", slot_index=2), out("fit_report", "STRING", slot_index=3)], [470, 500])
    ...
    save("api_26_production_review_loop", {
        ...
        "9": {"class_type": "T8_FireRedAudio_DurationFit", "inputs": {"audio_batch": ["8", 0], "strategy": "speech_aware", "tolerance_seconds": 0.1, "maximum_speed": 1.15, "fit_underrun": False, "minimum_speed": 0.9, "project_name": "v017-review-fit", "subfolder": "fireredaudio/duration-fit", "edge_silence_threshold_db": -40.0, "edge_silence_min_seconds": 0.05, "edge_padding_seconds": 0.12, "internal_pause_min_seconds": 0.18, "maximum_speech_speed": 1.12}},
        "10": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["9", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512, "use_asr_cache": True, "refresh_asr_cache": False}},
    ...
    creative_resume = node(2, "T8_FireRedAudio_AudioBatchResume", [60, 650], ["fireredaudio/projects/project/manifest.json", "mark_missing", False, False], [], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [6, 15]), out("resolved_manifest_path", "STRING", slot_index=1), out("resume_report", "STRING", slot_index=2)], [520, 300])
    ...
    creative_apply["title"] = "步骤 3 · 非破坏采用选中的候选"
    ...
    creative_links = [
        ...
        [6, 2, 0, 9, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"], [7, 6, 0, 9, 2, "T8_FIREREDAUDIO_SCRIPT_PLAN"],
        [8, 5, 0, 9, 3, "T8_FIREREDAUDIO_VOICE_BANK"], [9, 7, 0, 9, 5, "T8_FIREREDAUDIO_SETTINGS"],
        [10, 13, 0, 9, 4, "STRING"], [11, 9, 0, 10, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"],
        [12, 10, 1, 11, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"], [13, 10, 2, 11, 2, "STRING"],
        [14, 11, 0, 12, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [15, 2, 0, 11, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"],
    ]
    save("ui_28_creative_line_candidates", workflow([model_node([1]), creative_resume, creative_audio, creative_profile, creative_bank, creative_parser, creative_settings, creative_target, creative_pool, creative_take_review, creative_apply, creative_export], creative_links))
    save("api_28_creative_line_candidates", {
        ...
        "8": {"class_type": "PrimitiveStringMultiline", "inputs": {"value": "line-1"}},
        "9": {"class_type": "T8_FireRedAudio_CreativeCandidatePool", "inputs": {"model": ["1", 0], "audio_batch": ["2", 0], "script_plan": ["6", 0], "voice_bank": ["5", 0], "target_line_id": ["8", 0], "candidate_count": 3, "seed_start": 1001, "seed_step": 97, "include_original": True, "run_asr_qa": False, "project_name": "creative-line-candidates", "subfolder": "fireredaudio/candidates", "settings": ["7", 0], "minimum_acoustic_difference": 0.005}},
        "10": {"class_type": "T8_FireRedAudio_TakeReviewBoard", "inputs": {"audio_batch": ["9", 0], "selected_position": 0, "selected_line_id": "", "ratings_json": "{}", "notes_json": "{}", "review_name": "creative-blind-review", "subfolder": "fireredaudio/reviews", "preview_limit": 8}},
        "11": {"class_type": "T8_FireRedAudio_CandidateApply", "inputs": {"source_audio_batch": ["2", 0], "reviewed_candidates": ["10", 1], "selected_candidate_id": ["10", 2], "project_name": "creative-candidate-adoption", "subfolder": "fireredaudio/candidate-adoptions"}},
