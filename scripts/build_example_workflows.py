...
def build() -> None:
    ...
    settings = node(3, "T8_FireRedAudio_GenerationSettings", [470, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [3])], [320, 280])
    ...
    design_settings = node(2, "T8_FireRedAudio_GenerationSettings", [470, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [2])], [320, 280])
    ...
    export_settings = node(2, "T8_FireRedAudio_GenerationSettings", [470, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [2])], [320, 280])
    ...
    parser = node(7, "T8_FireRedAudio_ScriptParser", [1240, 460], ["旁白：欢迎收听本期节目。\n[00:00:03,000 --> 00:00:06,000] 小夏：大家好，我是小夏。", "role_script", False, "旁白"], [port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 6)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [7]), out("normalized_json", "STRING"), out("preflight_report", "STRING")], [430, 360])
    production_settings = node(8, "T8_FireRedAudio_GenerationSettings", [470, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [9])], [320, 280])
    ...
    speech_qa = node(11, "T8_FireRedAudio_SpeechQA", [2230, 590], [0.2, 0.001, 0.8, 0.5, 512, True, False], [port("model", "T8_FIREREDAUDIO_MODEL", 10), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 12)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA"), out("qa_report", "STRING"), out("failed_line_ids", "STRING")], [420, 330])
    ...
    save("api_13_role_dubbing_pipeline", {
        ...
        "11": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["9", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512, "use_asr_cache": True, "refresh_asr_cache": False}},
    ...
    srt_parser = node(5, "T8_FireRedAudio_ScriptParser", [1250, 350], ["1\n00:00:00,000 --> 00:00:02,500\n[旁白] 第一条字幕。\n\n2\n00:00:03,000 --> 00:00:05,500\n[旁白] 第二条字幕。", "srt", True, "旁白"], [port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 4)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [5]), out("normalized_json", "STRING"), out("preflight_report", "STRING")], [430, 390])
    srt_settings = node(6, "T8_FireRedAudio_GenerationSettings", [470, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [7])], [320, 280])
    ...
    reference_settings = node(4, "T8_FireRedAudio_GenerationSettings", [470, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [6])], [320, 280])
    ...
    audition_settings = node(3, "T8_FireRedAudio_GenerationSettings", [470, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [3])], [320, 280])
    ...
    loop_parser = node(7, "T8_FireRedAudio_ScriptParser", [1250, 470], ["旁白：欢迎进入批量创作闭环。\n小夏：未通过质检的台词会单独返修。\n旁白：通过的文件不会重新生成。", "role_script", True, "旁白"], [port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 6)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [7, 10]), out("normalized_json", "STRING"), out("preflight_report", "STRING")], [450, 390])
    loop_settings = node(8, "T8_FireRedAudio_GenerationSettings", [470, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [9, 15])], [320, 280])
    ...
    loop_qa = node(10, "T8_FireRedAudio_SpeechQA", [2280, 210], [0.2, 0.001, 0.8, 0.5, 512, True, False], [port("model", "T8_FIREREDAUDIO_MODEL", 20), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 11)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA"), out("qa_report", "STRING"), out("failed_line_ids", "STRING", [14], slot_index=2)], [450, 360])
    loop_retry = node(11, "T8_FireRedAudio_BatchRetry", [2780, 300], ["creator-loop-repair", "fireredaudio/repairs", "increment", 1, 2, 8, True, 0.5], [port("model", "T8_FIREREDAUDIO_MODEL", 12), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 13), port("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", 10), port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 21), port("failed_line_ids", "STRING", 14), port("settings", "T8_FIREREDAUDIO_SETTINGS", 15)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [16, 17, 18]), out("manifest_path", "STRING"), out("repair_report", "STRING")], [470, 430])
    ...
    save("api_20_creator_qa_repair_delivery", {
        ...
        "10": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["9", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512, "use_asr_cache": True, "refresh_asr_cache": False}},
        "11": {"class_type": "T8_FireRedAudio_BatchRetry", "inputs": {"model": ["1", 0], "audio_batch": ["9", 0], "script_plan": ["7", 0], "voice_bank": ["6", 0], "failed_line_ids": ["10", 2], "project_name": "creator-loop-repair", "subfolder": "fireredaudio/repairs", "seed_strategy": "increment", "seed_step": 1, "max_attempts": 2, "batch_size": 8, "settings": ["8", 0], "enforce_cue_duration": True, "max_cue_overrun_seconds": 0.5}},
    ...
    repair_settings = node(3, "T8_FireRedAudio_GenerationSettings", [470, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [6])], [320, 280])
    ...
    blind_settings = node(3, "T8_FireRedAudio_GenerationSettings", [460, 70], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [3])], [330, 280])
    ...
    benchmark_settings = node(3, "T8_FireRedAudio_GenerationSettings", [460, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [3])], [330, 280])
    ...
    review_audio = node(2, "LoadAudio", [60, 470], ["voice_reference.wav", None, None], [], [out("AUDIO", "AUDIO", [2])], [310, 170])
    review_profile = node(3, "T8_FireRedAudio_VoiceProfile", [430, 430], ["旁白", "这是参考音频逐字稿。", "zh", "旁白,制作审核"], [port("audio", "AUDIO", 2)], [out("profile", "T8_FIREREDAUDIO_VOICE_PROFILE", [3]), out("profile_json", "STRING", slot_index=1)], [380, 300])
    review_bank = node(4, "T8_FireRedAudio_VoiceBank", [850, 430], [], [port("profiles.profile_0", "T8_FIREREDAUDIO_VOICE_PROFILE", 3)], [out("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", [4, 8, 9]), out("voice_bank_json", "STRING", slot_index=1)], [340, 200])
    review_parser = node(5, "T8_FireRedAudio_ScriptParser", [850, 80], ["1\n00:00:00,000 --> 00:00:02,500\n[旁白] ＡＰＩ 于 2026-08-28 发布。\n\n2\n00:00:02,500 --> 00:00:05,000\n[旁白] 第二句进入逐句审核与返修闭环。", "srt", True, "旁白"], [port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 4)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [5]), out("normalized_json", "STRING", slot_index=1), out("preflight_report", "STRING", slot_index=2)], [500, 360])
    review_normalizer = node(6, "T8_FireRedAudio_TextNormalizer", [1410, 80], ['{"API":"A P I"}', True, True, True, False], [port("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", 5)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [6, 7]), out("normalized_json", "STRING", slot_index=1), out("changed_line_ids", "STRING", slot_index=2), out("normalization_report", "STRING", slot_index=3)], [460, 340])
    review_settings = node(7, "T8_FireRedAudio_GenerationSettings", [430, 80], ["balanced", 42, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [10, 11])], [330, 280])
    review_batch = node(8, "T8_FireRedAudio_BatchDubbing", [1930, 100], ["v014-review-demo", "fireredaudio/projects", True, True, 8], [port("model", "T8_FIREREDAUDIO_MODEL", 1), port("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", 6), port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 8), port("settings", "T8_FIREREDAUDIO_SETTINGS", 10)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [12]), out("manifest_path", "STRING", slot_index=1), out("batch_report", "STRING", slot_index=2)], [470, 420])
    review_fit = node(9, "T8_FireRedAudio_DurationFit", [2470, 100], ["speech_aware", 0.1, 1.15, False, 0.9, "v016-review-fit", "fireredaudio/duration-fit", -40.0, 0.05, 0.12], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 12)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [14, 15]), out("manifest_path", "STRING", slot_index=1), out("retry_line_ids", "STRING", slot_index=2), out("fit_report", "STRING", slot_index=3)], [470, 450])
    review_qa = node(10, "T8_FireRedAudio_SpeechQA", [3010, 100], [0.2, 0.001, 0.8, 0.5, 512, True, False], [port("model", "T8_FIREREDAUDIO_MODEL", 13), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 14)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA", [16]), out("qa_report", "STRING", slot_index=1), out("failed_line_ids", "STRING", slot_index=2)], [440, 350])
    review_board = node(11, "T8_FireRedAudio_LineReview", [3530, 80], ["{}", "{}", "{}", "v014-first-review", "fireredaudio/line-reviews", 40], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 15), port("qa", "T8_FIREREDAUDIO_SPEECH_QA", 16)], [out("reviewed_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [18]), out("approved_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", slot_index=1), out("retry_line_ids", "STRING", [19], slot_index=2), out("review_line_ids", "STRING", slot_index=3), out("review_manifest_path", "STRING", slot_index=4), out("review_report", "STRING", slot_index=5)], [1080, 600])
    review_retry = node(12, "T8_FireRedAudio_BatchRetry", [4680, 100], ["v014-review-repair", "fireredaudio/repairs", "increment", 7, 2, 8, True, 0.5], [port("model", "T8_FIREREDAUDIO_MODEL", 17), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 18), port("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", 7), port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 9), port("failed_line_ids", "STRING", 19), port("settings", "T8_FIREREDAUDIO_SETTINGS", 11)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [20, 22]), out("manifest_path", "STRING", slot_index=1), out("repair_report", "STRING", slot_index=2)], [490, 470])
    review_qa_final = node(13, "T8_FireRedAudio_SpeechQA", [5240, 100], [0.2, 0.001, 0.8, 0.5, 512, True, False], [port("model", "T8_FIREREDAUDIO_MODEL", 21), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 20)], [out("qa", "T8_FIREREDAUDIO_SPEECH_QA", [23]), out("qa_report", "STRING", slot_index=1), out("failed_line_ids", "STRING", slot_index=2)], [440, 350])
    review_board_final = node(14, "T8_FireRedAudio_LineReview", [5760, 80], ["{}", "{}", "{}", "v014-final-review", "fireredaudio/line-reviews", 40], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 22), port("qa", "T8_FIREREDAUDIO_SPEECH_QA", 23)], [out("reviewed_batch", "T8_FIREREDAUDIO_AUDIO_BATCH"), out("approved_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [24], slot_index=1), out("retry_line_ids", "STRING", slot_index=2), out("review_line_ids", "STRING", slot_index=3), out("review_manifest_path", "STRING", slot_index=4), out("review_report", "STRING", slot_index=5)], [1080, 600])
    review_export = node(15, "T8_FireRedAudio_SaveAudioBatch", [6910, 160], ["wav", "v014-approved", "fireredaudio/exports", True, True, 40], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 24)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH"), out("manifest_path", "STRING", slot_index=1), out("zip_path", "STRING", slot_index=2), out("export_report", "STRING", slot_index=3)], [440, 360])
    review_links = [[1, 1, 0, 8, 0, "T8_FIREREDAUDIO_MODEL"], [2, 2, 0, 3, 0, "AUDIO"], [3, 3, 0, 4, 0, "T8_FIREREDAUDIO_VOICE_PROFILE"], [4, 4, 0, 5, 0, "T8_FIREREDAUDIO_VOICE_BANK"], [5, 5, 0, 6, 0, "T8_FIREREDAUDIO_SCRIPT_PLAN"], [6, 6, 0, 8, 1, "T8_FIREREDAUDIO_SCRIPT_PLAN"], [7, 6, 0, 12, 2, "T8_FIREREDAUDIO_SCRIPT_PLAN"], [8, 4, 0, 8, 2, "T8_FIREREDAUDIO_VOICE_BANK"], [9, 4, 0, 12, 3, "T8_FIREREDAUDIO_VOICE_BANK"], [10, 7, 0, 8, 3, "T8_FIREREDAUDIO_SETTINGS"], [11, 7, 0, 12, 5, "T8_FIREREDAUDIO_SETTINGS"], [12, 8, 0, 9, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [13, 1, 0, 10, 0, "T8_FIREREDAUDIO_MODEL"], [14, 9, 0, 10, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"], [15, 9, 0, 11, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [16, 10, 0, 11, 1, "T8_FIREREDAUDIO_SPEECH_QA"], [17, 1, 0, 12, 0, "T8_FIREREDAUDIO_MODEL"], [18, 11, 0, 12, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"], [19, 11, 2, 12, 4, "STRING"], [20, 12, 0, 13, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"], [21, 1, 0, 13, 0, "T8_FIREREDAUDIO_MODEL"], [22, 12, 0, 14, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [23, 13, 0, 14, 1, "T8_FIREREDAUDIO_SPEECH_QA"], [24, 14, 1, 15, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"]]
    save("ui_26_production_review_loop", workflow([model_node([1, 13, 17, 21]), review_audio, review_profile, review_bank, review_parser, review_normalizer, review_settings, review_batch, review_fit, review_qa, review_board, review_retry, review_qa_final, review_board_final, review_export], review_links))
    save("api_26_production_review_loop", {
        "1": {"class_type": "T8_FireRedAudio_ModelLoader", "inputs": {"model_name": "FireRedAudio", "custom_model_path": "", "device": "auto", "memory_mode": "auto", "acceleration_mode": "auto_safe", "profile": "full", "worker_mode": "managed", "runtime_python": "", "worker_url": "", "worker_token": "", "verify_hashes": False, "release_after_run": False}},
        "2": {"class_type": "LoadAudio", "inputs": {"audio": "voice_reference.wav"}},
        "3": {"class_type": "T8_FireRedAudio_VoiceProfile", "inputs": {"audio": ["2", 0], "name": "旁白", "prompt_text": "这是参考音频逐字稿。", "language": "zh", "tags": "旁白,制作审核"}},
        "4": {"class_type": "T8_FireRedAudio_VoiceBank", "inputs": {"profiles.profile_0": ["3", 0]}},
        "5": {"class_type": "T8_FireRedAudio_ScriptParser", "inputs": {"voice_bank": ["4", 0], "script": "1\n00:00:00,000 --> 00:00:02,500\n[旁白] ＡＰＩ 于 2026-08-28 发布。\n\n2\n00:00:02,500 --> 00:00:05,000\n[旁白] 第二句进入逐句审核与返修闭环。", "source_format": "srt", "default_speaker": "旁白", "strict_validation": True}},
        "6": {"class_type": "T8_FireRedAudio_TextNormalizer", "inputs": {"script_plan": ["5", 0], "replacement_dictionary_json": "{\"API\":\"A P I\"}", "normalize_unicode": True, "normalize_whitespace": True, "expand_zh_dates": True, "expand_zh_numbers": False}},
        "7": {"class_type": "T8_FireRedAudio_GenerationSettings", "inputs": {"quality_preset": "balanced", "seed": 42, "max_new_audio_steps": 750, "min_new_audio_steps": 6, "max_new_text_tokens": 512, "n_timesteps": 10, "inference_cfg": 2.0}},
        "8": {"class_type": "T8_FireRedAudio_BatchDubbing", "inputs": {"model": ["1", 0], "script_plan": ["6", 0], "voice_bank": ["4", 0], "project_name": "v014-review-demo", "subfolder": "fireredaudio/projects", "resume": True, "continue_on_error": True, "batch_size": 8, "settings": ["7", 0]}},
        "9": {"class_type": "T8_FireRedAudio_DurationFit", "inputs": {"audio_batch": ["8", 0], "strategy": "speech_aware", "tolerance_seconds": 0.1, "maximum_speed": 1.15, "fit_underrun": False, "minimum_speed": 0.9, "project_name": "v016-review-fit", "subfolder": "fireredaudio/duration-fit", "edge_silence_threshold_db": -40.0, "edge_silence_min_seconds": 0.05, "edge_padding_seconds": 0.12}},
        "10": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["9", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512, "use_asr_cache": True, "refresh_asr_cache": False}},
        "11": {"class_type": "T8_FireRedAudio_LineReview", "inputs": {"audio_batch": ["9", 0], "qa": ["10", 0], "decisions_json": "{}", "ratings_json": "{}", "notes_json": "{}", "review_name": "v014-first-review", "subfolder": "fireredaudio/line-reviews", "preview_limit": 40}},
        "12": {"class_type": "T8_FireRedAudio_BatchRetry", "inputs": {"model": ["1", 0], "audio_batch": ["11", 0], "script_plan": ["6", 0], "voice_bank": ["4", 0], "failed_line_ids": ["11", 2], "project_name": "v014-review-repair", "subfolder": "fireredaudio/repairs", "seed_strategy": "increment", "seed_step": 7, "max_attempts": 2, "batch_size": 8, "settings": ["7", 0], "enforce_cue_duration": True, "max_cue_overrun_seconds": 0.5}},
        "13": {"class_type": "T8_FireRedAudio_SpeechQA", "inputs": {"model": ["1", 0], "audio_batch": ["12", 0], "max_text_error_rate": 0.2, "max_clipping_ratio": 0.001, "max_silence_ratio": 0.8, "max_cue_overrun_seconds": 0.5, "max_new_tokens": 512, "use_asr_cache": True, "refresh_asr_cache": False}},
        "14": {"class_type": "T8_FireRedAudio_LineReview", "inputs": {"audio_batch": ["12", 0], "qa": ["13", 0], "decisions_json": "{}", "ratings_json": "{}", "notes_json": "{}", "review_name": "v014-final-review", "subfolder": "fireredaudio/line-reviews", "preview_limit": 40}},
        "15": {"class_type": "T8_FireRedAudio_SaveAudioBatch", "inputs": {"audio_batch": ["14", 1], "audio_format": "wav", "project_name": "v014-approved", "subfolder": "fireredaudio/exports", "create_zip": True, "continue_on_error": True, "preview_limit": 40}},
    })

    resume = node(1, "T8_FireRedAudio_AudioBatchResume", [80, 100], ["fireredaudio/line-reviews/production-review-YYYYMMDD/review-manifest.json", "mark_missing", False, False], [], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [1]), out("resolved_manifest_path", "STRING", slot_index=1), out("resume_report", "STRING", slot_index=2)], [520, 300])
    resume_review = node(2, "T8_FireRedAudio_LineReview", [680, 80], ["{}", "{}", "{}", "resumed-review", "fireredaudio/line-reviews", 80], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 1)], [out("reviewed_batch", "T8_FIREREDAUDIO_AUDIO_BATCH"), out("approved_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [2], slot_index=1), out("retry_line_ids", "STRING", slot_index=2), out("review_line_ids", "STRING", slot_index=3), out("review_manifest_path", "STRING", slot_index=4), out("review_report", "STRING", slot_index=5)], [1080, 600])
    resume_export = node(3, "T8_FireRedAudio_SaveAudioBatch", [1840, 140], ["wav", "resumed-approved", "fireredaudio/exports", True, True, 80], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 2)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH"), out("manifest_path", "STRING", slot_index=1), out("zip_path", "STRING", slot_index=2), out("export_report", "STRING", slot_index=3)], [440, 360])
    save("ui_27_resume_review_session", workflow([resume, resume_review, resume_export], [[1, 1, 0, 2, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [2, 2, 1, 3, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"]]))
    save("api_27_resume_review_session", {
        "1": {"class_type": "T8_FireRedAudio_AudioBatchResume", "inputs": {"manifest_path": "fireredaudio/line-reviews/production-review-YYYYMMDD/review-manifest.json", "missing_policy": "mark_missing", "verify_hashes": False, "allow_external_manifest": False}},
        "2": {"class_type": "T8_FireRedAudio_LineReview", "inputs": {"audio_batch": ["1", 0], "decisions_json": "{}", "ratings_json": "{}", "notes_json": "{}", "review_name": "resumed-review", "subfolder": "fireredaudio/line-reviews", "preview_limit": 80}},
        "3": {"class_type": "T8_FireRedAudio_SaveAudioBatch", "inputs": {"audio_batch": ["2", 1], "audio_format": "wav", "project_name": "resumed-approved", "subfolder": "fireredaudio/exports", "create_zip": True, "continue_on_error": True, "preview_limit": 80}},
    })

    creative_resume = node(2, "T8_FireRedAudio_AudioBatchResume", [60, 650], ["fireredaudio/projects/project/manifest.json", "mark_missing", False, False], [], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [5]), out("resolved_manifest_path", "STRING", slot_index=1), out("resume_report", "STRING", slot_index=2)], [520, 300])
    creative_audio = node(3, "LoadAudio", [60, 390], ["narrator_reference.wav", None, None], [], [out("AUDIO", "AUDIO", [2])], [300, 170])
    creative_profile = node(4, "T8_FireRedAudio_VoiceProfile", [420, 380], ["旁白", "这是旁白参考音频的逐字稿。", "zh", "创意候选"], [port("audio", "AUDIO", 2)], [out("profile", "T8_FIREREDAUDIO_VOICE_PROFILE", [3]), out("profile_json", "STRING", slot_index=1)], [390, 280])
    creative_bank = node(5, "T8_FireRedAudio_VoiceBank", [870, 400], [], [port("profile_0", "T8_FIREREDAUDIO_VOICE_PROFILE", 3)], [out("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", [4, 8]), out("voice_bank_json", "STRING", slot_index=1)], [360, 220])
    creative_parser = node(6, "T8_FireRedAudio_ScriptParser", [1280, 360], ["旁白：请把这里替换为原制作脚本，并保持 line ID 一致。", "role_script", False, "旁白"], [port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 4)], [out("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", [7]), out("normalized_json", "STRING", slot_index=1), out("preflight_report", "STRING", slot_index=2)], [480, 380])
    creative_settings = node(7, "T8_FireRedAudio_GenerationSettings", [470, 80], ["balanced", 1001, "fixed", 750, 6, 512, 10, 2.0], [], [out("settings", "T8_FIREREDAUDIO_SETTINGS", [9])], [320, 280])
    creative_review = node(8, "T8_FireRedAudio_LineReview", [1840, 560], ["{}", "{}", "{}", "creative-target", "fireredaudio/line-reviews", 40], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 5)], [out("reviewed_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [6, 15]), out("approved_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", slot_index=1), out("retry_line_ids", "STRING", [10], slot_index=2), out("review_line_ids", "STRING", slot_index=3), out("review_manifest_path", "STRING", slot_index=4), out("review_report", "STRING", slot_index=5)], [1080, 600])
    creative_pool = node(9, "T8_FireRedAudio_CreativeCandidatePool", [3020, 300], [3, 1001, 97, True, False, "creative-line-candidates", "fireredaudio/candidates"], [port("model", "T8_FIREREDAUDIO_MODEL", 1), port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 6), port("script_plan", "T8_FIREREDAUDIO_SCRIPT_PLAN", 7), port("voice_bank", "T8_FIREREDAUDIO_VOICE_BANK", 8), port("target_line_id", "STRING", 10), port("settings", "T8_FIREREDAUDIO_SETTINGS", 9)], [out("candidate_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [11]), out("source_line_id", "STRING", slot_index=1), out("manifest_path", "STRING", slot_index=2), out("candidate_report", "STRING", slot_index=3)], [560, 500])
    creative_take_review = node(10, "T8_FireRedAudio_TakeReviewBoard", [3660, 340], [1, "{}", "{}", "creative-blind-review", "fireredaudio/reviews", 8, ""], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 11)], [out("selected_audio", "AUDIO", slot_index=0), out("reviewed_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [12], slot_index=1), out("selected_line_id", "STRING", [13], slot_index=2), out("review_manifest_path", "STRING", slot_index=3), out("review_report", "STRING", slot_index=4)], [660, 520])
    creative_apply = node(11, "T8_FireRedAudio_CandidateApply", [4410, 380], ["creative-candidate-adoption", "fireredaudio/candidate-adoptions"], [port("source_audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 15), port("reviewed_candidates", "T8_FIREREDAUDIO_AUDIO_BATCH", 12), port("selected_candidate_id", "STRING", 13)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", [14]), out("selected_audio", "AUDIO", slot_index=1), out("manifest_path", "STRING", slot_index=2), out("adoption_report", "STRING", slot_index=3)], [520, 360])
    creative_export = node(12, "T8_FireRedAudio_SaveAudioBatch", [5020, 390], ["wav", "creative-adopted", "fireredaudio/exports", True, True, 40], [port("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH", 14)], [out("audio_batch", "T8_FIREREDAUDIO_AUDIO_BATCH"), out("manifest_path", "STRING", slot_index=1), out("zip_path", "STRING", slot_index=2), out("export_report", "STRING", slot_index=3)], [460, 380])
    creative_links = [
        [1, 1, 0, 9, 0, "T8_FIREREDAUDIO_MODEL"], [2, 3, 0, 4, 0, "AUDIO"],
        [3, 4, 0, 5, 0, "T8_FIREREDAUDIO_VOICE_PROFILE"], [4, 5, 0, 6, 0, "T8_FIREREDAUDIO_VOICE_BANK"],
        [5, 2, 0, 8, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [6, 8, 0, 9, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"],
        [7, 6, 0, 9, 2, "T8_FIREREDAUDIO_SCRIPT_PLAN"], [8, 5, 0, 9, 3, "T8_FIREREDAUDIO_VOICE_BANK"],
        [9, 7, 0, 9, 5, "T8_FIREREDAUDIO_SETTINGS"], [10, 8, 2, 9, 4, "STRING"],
        [11, 9, 0, 10, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"], [12, 10, 1, 11, 1, "T8_FIREREDAUDIO_AUDIO_BATCH"],
        [13, 10, 2, 11, 2, "STRING"], [14, 11, 0, 12, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"],
        [15, 8, 0, 11, 0, "T8_FIREREDAUDIO_AUDIO_BATCH"],
    ]
    save("ui_28_creative_line_candidates", workflow([model_node([1]), creative_resume, creative_audio, creative_profile, creative_bank, creative_parser, creative_settings, creative_review, creative_pool, creative_take_review, creative_apply, creative_export], creative_links))
    save("api_28_creative_line_candidates", {
        "1": {"class_type": "T8_FireRedAudio_ModelLoader", "inputs": {"model_name": "FireRedAudio", "custom_model_path": "", "device": "auto", "memory_mode": "auto", "acceleration_mode": "auto_safe", "profile": "full", "worker_mode": "managed", "runtime_python": "", "worker_url": "", "worker_token": "", "verify_hashes": False, "release_after_run": False}},
        "2": {"class_type": "T8_FireRedAudio_AudioBatchResume", "inputs": {"manifest_path": "fireredaudio/projects/project/manifest.json", "missing_policy": "mark_missing", "verify_hashes": False, "allow_external_manifest": False}},
        "3": {"class_type": "LoadAudio", "inputs": {"audio": "narrator_reference.wav"}},
        "4": {"class_type": "T8_FireRedAudio_VoiceProfile", "inputs": {"audio": ["3", 0], "name": "旁白", "prompt_text": "这是旁白参考音频的逐字稿。", "language": "zh", "tags": "创意候选"}},
        "5": {"class_type": "T8_FireRedAudio_VoiceBank", "inputs": {"profiles.profile_0": ["4", 0]}},
        "6": {"class_type": "T8_FireRedAudio_ScriptParser", "inputs": {"script": "旁白：请把这里替换为原制作脚本，并保持 line ID 一致。", "source_format": "role_script", "default_speaker": "旁白", "strict_validation": False, "voice_bank": ["5", 0]}},
        "7": {"class_type": "T8_FireRedAudio_GenerationSettings", "inputs": {"quality_preset": "balanced", "seed": 1001, "max_new_audio_steps": 750, "min_new_audio_steps": 6, "max_new_text_tokens": 512, "n_timesteps": 10, "inference_cfg": 2.0}},
        "8": {"class_type": "T8_FireRedAudio_LineReview", "inputs": {"audio_batch": ["2", 0], "decisions_json": "{}", "ratings_json": "{}", "notes_json": "{}", "review_name": "creative-target", "subfolder": "fireredaudio/line-reviews", "preview_limit": 40}},
        "9": {"class_type": "T8_FireRedAudio_CreativeCandidatePool", "inputs": {"model": ["1", 0], "audio_batch": ["8", 0], "script_plan": ["6", 0], "voice_bank": ["5", 0], "target_line_id": ["8", 2], "candidate_count": 3, "seed_start": 1001, "seed_step": 97, "include_original": True, "run_asr_qa": False, "project_name": "creative-line-candidates", "subfolder": "fireredaudio/candidates", "settings": ["7", 0]}},
        "10": {"class_type": "T8_FireRedAudio_TakeReviewBoard", "inputs": {"audio_batch": ["9", 0], "selected_position": 1, "selected_line_id": "", "ratings_json": "{}", "notes_json": "{}", "review_name": "creative-blind-review", "subfolder": "fireredaudio/reviews", "preview_limit": 8}},
        "11": {"class_type": "T8_FireRedAudio_CandidateApply", "inputs": {"source_audio_batch": ["8", 0], "reviewed_candidates": ["10", 1], "selected_candidate_id": ["10", 2], "project_name": "creative-candidate-adoption", "subfolder": "fireredaudio/candidate-adoptions"}},
        "12": {"class_type": "T8_FireRedAudio_SaveAudioBatch", "inputs": {"audio_batch": ["11", 0], "audio_format": "wav", "project_name": "creative-adopted", "subfolder": "fireredaudio/exports", "create_zip": True, "continue_on_error": True, "preview_limit": 40}},
    })
